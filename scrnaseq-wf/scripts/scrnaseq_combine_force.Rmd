...
knitr::opts_knit$set(
#  root.dir = '/home/fearjm/Deploy/larval_gonad_ovary/scrnaseq-wf'
  root.dir = '../'
)
```
...
OUTDIR <- '../output/scrnaseq-wf/scrnaseq_combine_force'
...
load.data <- function(fname, name){
  ...
  # Create the Seurat object, require a gene to be in ≥3 cells, and a cell to
  # have ≥200 genes.
  ...
  # Identify variable genes while controling for the relationship b/t
  # variability and expression level.
  ...
  # I prefer working in python so pull out the different parts of the seurat
  # object and save.
  ...
  # Add replicate prefix to make cells unique when merging reps.
...
CCA requires a list of highly variable genes. Here I pull out variable genes from each replicate and then identify genes that are in common.
...
Run CCA and get diagnostics out.
...
# Here is where we actually call clusters
combined <- FindClusters(combined, reduction.type = "cca.aligned", resolution = params, dims.use = 1:25, print.output = FALSE)
```
