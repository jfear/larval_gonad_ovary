...
r1 <- load.data('../data/scrnaseq_samples/ovary1_force/outs/filtered_gene_bc_matrices/dm6.16', 'rep1')
r2 <- load.data('../data/scrnaseq_samples/ovary2_force/outs/filtered_gene_bc_matrices/dm6.16', 'rep2')
r3 <- load.data('../data/scrnaseq_samples/ovary3_force/outs/filtered_gene_bc_matrices/dm6.16', 'rep3')
```
